      ...
      <div className="footer-top bg-white py-[64px] lg:block hidden">
        <div className="mx-auto container px-4 max-w-[878px]">
          <div className="flex flex-wrap">
            <div className="w-1/4">
              <h2 className="text-[18px] text-primary font-bold leading-[18px] m-[0px]">Fundraise</h2>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Virtual Fundraising</Link>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Brochure Fundraising</Link>
            </div>
            <div className="w-1/4">
              <h2 className="text-[18px] text-primary font-bold leading-[18px] m-[0px]">Shop</h2>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Shop Cookies</Link>
            </div>
            <div className="w-1/4">
              <h2 className="text-[18px] text-primary font-bold leading-[18px] m-[0px]">About</h2>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">About Us</Link>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Careers</Link>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Blog</Link>
            </div>
            <div className="w-1/4">
              <h2 className="text-[18px] text-primary font-bold leading-[18px] m-[0px]">Need More Help?</h2>
              <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary mt-[12px] mb-[0px]">Contact Us</Link>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap items-center lg:justify-between mx-[-10px]">
            ...
            <div className="px-[10px] w-full lg:w-auto text-center mt-[12px] lg:mt-[0px]">
              <div className="flex flex-wrap mx-[-5px] justify-center">
                <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary px-[5px]">Privacy Policy</Link>
                <Link href="javascript:void(0)" className="hover:text-ternary block text-[16px] leading-[22px] text-secondary px-[5px]">Terms & Conditions</Link>
              </div>
            </div>
          </div>
        </div>
