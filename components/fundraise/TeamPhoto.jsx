...
export default function TeamPhoto({page, setPage, setIsActive, isActive}) {
  ...
  return (
    <>
      <h2 className="text-[24px] font-bold leading-[26px] text-primary mb-[15px] mt-[30px]">Add A Team photo</h2>
      <div className="mt-[32px] grow">
        <div className="w-[138px] relative overflow-hidden">
          ...
          <label className="flex item-center p-[12px] rounded-[5px] border border-black text-[16px] font-bold text-primary">Add Photo <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
