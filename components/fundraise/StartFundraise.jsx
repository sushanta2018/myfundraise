...
export default function StartFundraise({page, setPage, setIsActive, isActive}) {
  ...
  return (
    <>
      <h2 className="text-[24px] font-bold leading-[26px] text-primary mb-[15px] mt-[30px]">{t("startFundraise")}</h2>
      <div className="mt-[32px] grow">
        <ul className='flex flex-wrap mx-[-4px]'>
          <li className='px-[4px] mb-[8px]'>
            <div className='relative item-radio-card'>
              ...
              <label className='block py-[8px] px-[24px] rounded-[100px] border border-black text-[16px] leading-[22px]'>{t("asap")}</label>
            </div>
          </li>
          <li className='px-[4px] mb-[8px]'>
            <div className='relative item-radio-card'>
              <input type="radio" name="start_fund" className='absolute z-10 top-0 left-0 w-full h-full opacity-0 cursor-pointer'/>
              <label className='block py-[8px] px-[24px] rounded-[100px] border border-black text-[16px] leading-[22px]'>{t("inTheNext4weeks")}</label>
            </div>
          </li>
          <li className='px-[4px] mb-[8px]'>
            <div className='relative item-radio-card'>
              <input type="radio" name="start_fund" className='absolute z-10 top-0 left-0 w-full h-full opacity-0 cursor-pointer'/>
              <label className='block py-[8px] px-[24px] rounded-[100px] border border-black text-[16px] leading-[22px]'>{t("inTheNextFewMonths")}</label>
            </div>
          </li>
          <li className='px-[4px] mb-[8px]'>
            <div className='relative item-radio-card'>
              <input type="radio" name="start_fund" className='absolute z-10 top-0 left-0 w-full h-full opacity-0 cursor-pointer'/>
              <label className='block py-[8px] px-[24px] rounded-[100px] border border-black text-[16px] leading-[22px]'>{t("imNotSure")}</label>
            </div>
          </li>
        </ul>
        <div className="mt-[30px]">
          <ReactDatePicker
            ...
            placeholderText={t("pickSpecificDate")}
          />
        </div>
      </div>
