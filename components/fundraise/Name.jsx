export default function Name({page, setPage, setIsActive, isActive}) {
  return (
    <>
      <h2 className="text-[24px] font-bold leading-[26px] text-primary mb-[15px] mt-[30px]">Type in the name of your team</h2>
      <p className="block text-[16px] leading-[22px] text-secondary">The team name will be displayed on each participant’s Virtual Cookie Shop.</p>
      <div className="mt-[32px] grow">
        <input class="border-0 border-b h-[40px] py-[8px] placeholder-secondary text-dark w-full form-control text-[16px]" placeholder="Name" type="text"/>
      </div>
