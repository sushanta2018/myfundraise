...
export default function VerifyCode() {
  ...
  return (
    <>
      ...
      { !isShow &&
        <>
          <h2 className="text-[24px] font-bold leading-[26px] text-primary mb-[5px]">Enter the code</h2>
          <p className="block text-[16px] leading-[22px] text-secondary">We sent an SMS to 000-000-0000</p>
          <div className="mt-[32px] grow">
            ...
            <p className="block text-[16px] leading-[22px] text-secondary mt-[32px]">Didn’t get the code? <Link className="text-ternary" 
            onClick={ () => setIsShow(!isShow) } href="javascript:void(0)">More options</Link></p>
          </div>
          <div className="flex mt-[20px]">
            <button type="button" className="btn-hover py-[10px] px-[24px] rounded-[40px] text-[16px] font-bold bg-ternary text-white flex items-center">Container <svg className="ml-[10px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
